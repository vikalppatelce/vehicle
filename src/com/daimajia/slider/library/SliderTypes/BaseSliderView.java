...
public abstract class BaseSliderView {
	...
	protected BaseSliderView(Context context) {
		...
		options = new DisplayImageOptions.Builder()
				.showImageOnLoading(R.drawable.hannibal)
				.showImageForEmptyUri(R.drawable.hannibal)
				.showImageOnFail(R.drawable.hannibal).cacheInMemory()
				.cacheOnDisc().build();
	}
	...
	protected void bindEventAndShow(final View v, ImageView targetImageView) {
		...
		imageLoader.displayImage(mUrl, targetImageView,
		...
		// rq = p.load(mUrl);
		// }/*
		// * else if(mFile != null){ rq = p.load(mFile); }else if(mRes != 0){ rq
		// =
		// * p.load(mRes); }
		// */else {
		// return;
